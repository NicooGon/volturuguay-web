...
export default function ServiceCard({ num, icon: Icon, title, desc }) {
  return (
    <div className="group relative p-10 rounded-2xl bg-white border-[1.5px] border-[#DDE5EF] hover:border-[#2F7FD8] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(11,31,58,0.1)] cursor-default overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-0.75 bg-[#2F7FD8] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-350" />
      ...
      <div className="w-12.5 h-12.5 rounded-xl bg-[#E8F3FF] group-hover:bg-[#2F7FD8]/10 border-[1.5px] border-[#DDE5EF] group-hover:border-[#2F7FD8]/20 flex items-center justify-center mb-5 text-[#2F7FD8] transition-all duration-300">
