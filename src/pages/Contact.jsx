...
export default function ContactSection() {
  ...
  return (
    <section id="contacto" className="relative py-28 px-4 sm:px-8 md:px-[6vw] bg-[#050A18] overflow-hidden">
      <Particles/>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-75 h-75 md:w-150 md:h-150 bg-[#2F7FD8]/10 blur-[80px] md:blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center w-full min-w-0">
          ...
          <div data-aos="fade-right">
            <span className="text-[#2F7FD8] text-[0.7rem] font-bold uppercase tracking-[0.3em] flex items-center gap-3 mb-6">
              <span className="w-10 h-px bg-[#2F7FD8]" /> Contactanos
            </span>
            <h2 className="text-4xl md:text-5xl lg:text-[3.2rem] font-extrabold text-white leading-none tracking-tighter mb-8">
          ...
          <div className="relative group w-full min-w-0" data-aos="fade-left">
            <div className="absolute inset-0 bg-linear-to-r from-[#2F7FD8] to-blue-600 rounded-3xl md:rounded-[3rem] blur opacity-10 group-hover:opacity-20 transition duration-1000"></div>

            <div className="relative bg-[#0A1124] p-6 md:p-10 lg:p-14 rounded-3xl md:rounded-[3rem] border border-white/10 shadow-2xl w-full min-w-0">
