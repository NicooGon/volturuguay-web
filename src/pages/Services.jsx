...
export default function Services() {
  ...
  return (
    <section id="servicios" className="relative overflow-hidden bg-[#F7F9FC] py-28 px-[6vw]">
      ...
      <div className="absolute top-0 left-0 w-full h-125 md:h-150">
        <svg 
          className="w-[120%] md:w-[80%] h-full opacity-6 blur-[1px] translate-x-[-37%] translate-y-[-10%] -rotate-2"
          viewBox="0 0 900 220" 
      ...
      <div className="absolute bottom-0 right-0 w-full h-125 md:h-150">
        <svg 
          className="w-[120%] md:w-[80%] h-full opacity-6 blur-[1px] translate-x-[40%] translate-y-[15%] -rotate-2" 
          viewBox="0 0 700 180" 
